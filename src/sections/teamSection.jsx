    ...
    <section className="max-w-[1400px] mx-auto my-10 overflow-hidden relative">
      <div className="mb-5">
        ...
        <p className="text-lg w-150 text-center text-gray-500 mx-auto">
          We give our employees chance to grow and reach their potential. Our
          team has expertise in guiding students, and we make sure each employee
          is informed on industry trends.
        </p>
      </div>
      <div
                ...
                >
                  ...
                  >
                    ...
                    <p className="mt-3 font-normal text-sm mb-16">
                      We will help you choose the best country for your academic
                      and personal goals.
                    </p>
