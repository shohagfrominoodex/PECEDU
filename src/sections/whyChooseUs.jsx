...
export default function WhyChooseUs() {
     return (
          <section className="w-full bg-[#EEF6FF] py-16 px-4 sm:px-6 lg:px-8 overflow-x-hidden">
               <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col items-center md:justify-between gap-6 mb-12">
                         ...
                         >
                              We provide expert guidance and global
                              opportunities to shape your future career with
                              confidence and ease.
                         </motion.p>
                    </div>
