            ...
            <section className="flex gap-5 mt-20 items-center relative bg-linear-to-b from-[#CFFFE1] to-white rounded-[40px] p-20">
                ...
                <section className="w-6/12">
                    ...
                    <p className="mt-8 text-lg text-[#083216] w-120">
                        ...
                        guidance, and trusted global university partnerships, we
                        make every step from applications to visas smooth and
                        stress-free. Your future deserves the best path, and
