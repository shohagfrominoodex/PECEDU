...
const AboutSection = () => {
  return (
    <section className="my-30">
      ...
      <section className="mt-20 max-w-full mx-auto relative bg-linear-to-b from-[#0d9c7de3] to-white xl:rounded-t-[150px]">
        <section className="max-w-7xl mx-auto flex items-center gap-10 pt-20">
