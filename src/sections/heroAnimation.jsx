...
const HeroAnimation = () => {
    ...
    return (
        <section className="px-4 overflow-x-hidden py-10 md:py-20 lg:py-40 bg-[url(/images/hero-background.webp)] xl:bg-left bg-left bg-no-repeat relative bg-cover flex items-center">
                ...
                <section className="relative z-10 text-center lg:text-left lg:mt-30 xl:mt-0 mt-20 lg:w-1/2">
                    <div>
                        ...
                        >
                            ...
                            <br /> Study in{" "}
                            <span className="text-[#dcf500]">Denmark</span>
                        </motion.h1>
            ...
            <div className="absolute z-0 bottom-26.5 md:bottom-32 left-1/2 -translate-x-1/2 lg:bottom-22.5 xl:left-115 2xl:left-130 2xl:bottom-24 lg:left-80 w-80 md:w-90 lg:w-150 flex justify-center lg:block opacity-80 lg:opacity-100">
                <Image
