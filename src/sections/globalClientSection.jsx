...
const GlobalClients = () => {
    ...
    return (
        <section className="py-10 bg-linear-to-r from-[#050505] via-[#161616] to-[#050505]">
            <h1 className="font-semibold text-lg text-center text-gray-300">
                Global clients around the world
            </h1>
            <section className="grid md:grid-cols-2 lg:grid-cols-4 max-w-6xl mx-auto">
