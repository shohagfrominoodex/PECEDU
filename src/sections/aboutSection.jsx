        ...
        <section className="relative py-20 overflow-hidden bg-[#0A0A0A] text-white">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="flex flex-col items-center text-center">
                    ...
                    >
                        Learn About The Best <br /> Study Abroad Deals With
                        PecEdu
                    </motion.h1>
                    ...
                    >
                        We’re just a call away – get free expert guidance from
                    ...
                    <section className="flex items-center flex-col gap-x-15 lg:flex-row container">
                        ...
                        >
                            ...
                            <p className="text-base xl:text-lg text-white/70 mt-5 w-full text-start md:text-center md:px-20 lg:px-0 lg:max-w-xl lg:text-start ">
                                At Eduvisors, we turn your study abroad dreams
                                into reality. With 17+ years of expertise,
                                personalized guidance, and trusted global
                                university partnerships, we make every step from
                                applications to visas smooth and stress-free.
                                Your future deserves the best path, and we’re
